...
class Tree:
    ...
    def __init__(self, max_level=None):
        ...
        self.arc_dict = {}
        self.visited_nodes = {}
        self.level_counters = {}  # Glabā skaitītāju katram līmenim
...
class GameScreen:
    def __init__(self, root, num_string, starting_player, algorithm):
        ...
        self.frame = tk.Frame(self.root)  # Galvenais spēles rāmis
        self.frame.pack()

        self.status_label = tk.Label(self.frame, text="", font=("Helvetica", 12))  # Informācija par gājienu
        self.status_label.pack(pady=5)

        self.string_frame = tk.Frame(self.frame)  # Rāmis virknes attēlošanai
    ...
    def player_move(self, index):
        ...
        # Aizvieto skaitļu summu pēc spēles noteikumiem
        if pair_sum > 7:
